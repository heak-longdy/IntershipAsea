...
@section('layout')
    @include('admin::shared.header', ['header_name' => 'Job Management', 'customClass' => 'headerInForm'])
    <div class="form-admin" x-data="xComponent">
        <div class="form-bg"></div>
        <form id="form" class="form-wrapper" action="{!! route('admin-job-save', request('id')) !!}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-body">
                ...
                <div class="row-4">
                    ...
                    <div class="form-row iconInput">
                        <label>Post Date<span>*</span></label>
                        <input type="text" x-ref="post_date" name="post_date" placeholder="Post Date" value="{!! $data?->post_date ?? old('post_date') !!}" id="post_date" autocomplete="off">
                    ...
                    <div class="form-row iconInput">
                        ...
                        <input type="text" name="close_date" x-model="close_date" class="inputReadOnly" placeholder="Close Date" id="close_date" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <select name="placement_type_id" id="placement_type_id">
                            ...
                            <template x-for="item in placement_typeL_list">
                                <option :value="item.id" x-text="item.title" :selected="item.id == placement_type.id ? true : false"></option>
                            </template> 
                        </select>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data("xComponent", () => ({
                ...
                async init() {
                    ...
                    this.placement_type.id = data?.placement_type_id ?? `{{old('placement_type_id')}}`;
                    ...
                    tinymce.init({
                        ...
                        setup: (editor) => {
                            ...
                            editor.ui.registry.addMenuButton('customEmojis', {
                                ...
                                fetch: (callback) => {
                                    var items = [
                                        { type: 'menuitem', text: '👍', onAction: () => { editor.insertContent('👍'); }},
                                        { type: 'menuitem', text: '🎉', onAction: () => { editor.insertContent('🎉'); }},
                                        { type: 'menuitem', text: '✅', onAction: () => { editor.insertContent('✅'); }},
                                        { type: 'menuitem', text: '✔︎', onAction: () => { editor.insertContent('✔︎'); }},
                                    ];
                                    callback(items);
                                }
                            });
