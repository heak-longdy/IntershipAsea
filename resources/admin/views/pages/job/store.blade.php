    ...
    <div class="form-admin" x-data="xComponent">
        ...
        <form id="form" class="form-wrapper" action="{!! route('admin-job-save', request('id')) !!}" method="POST" enctype="multipart/form-data">
            <div class="form-header">
                <h3>
                    <i data-feather="arrow-left" s-click-link="{!! route('admin-job-list', 1) !!}"></i>
            ...
            <div class="form-body">
                ...
                <div class="form-button">
                    ...
                    <button color="danger" type="button" s-click-link="{!! route('admin-job-list', 1) !!}">
                        <i data-feather="x"></i>
                        <span>Cancel</span>
                    </button>
                </div>
                                    ...
                                    fileManager({
                                        ...
                                        afterClose: (result, baseDes) => {
                                            if (result && result.length > 0) {
                                                result.map((file) => {
                                                    const img = editor.dom.createHTML('img', {src: baseDes + file.path,style: 'width:100%;'});
