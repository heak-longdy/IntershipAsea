                        ...
                        <div class="appLeft">
                            ...
                            <div class="inputWithLabelLy">
                                ...
                                <textarea _ngcontent-pyh-c10="" class="contact__form-input ng-pristine ng-valid ng-touched inputField" cols="30"
                                    id="" name="project"
                                    placeholder="Tell us a little bit about yourself and why you're applying for this role" rows="10"></textarea>
                            </div>
                            ...
                            <div class="fileUploadLayout">
                                ...
                                <div class="actions">
                                    <label for="file" class="button upload-btn">
                                        <div style="display: flex;align-items: center;grid-gap: 7px;">
                                            ...
                                            <span style="line-height: 0;display: flex;align-items: center;">Choose
                                                File</span>
                                        </div>
                                ...
                                <div class="resultFile">
                                    <div class="file-uploaded">
                                        <p style="display: flex;align-items: center;    overflow: hidden;flex:1;"><i
                                                class='bx bx-file'
                                                style="    margin-right: 7px;"></i><span>profile_pic.pngprofile_pic.pngprofile_pic.pngprofile_pic.pngprofile_pic.pngprofile_pic.pngprofile_pic.png</span>
                                        </p>
                                        <i class='bx bx-x' style="width: 30px;display: flex;justify-content: flex-end;"></i>
                                    </div>
                                </div>
                            </div>
